...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['text_google_adword'] = $this->language->get('text_google_adword');
		$data['text_google_webmaster'] = $this->language->get('text_google_webmaster');
		...
		$data['entry_google_adword'] = $this->language->get('entry_google_adword');
		$data['entry_google_webmaster'] = $this->language->get('entry_google_webmaster');
		...
		$data['help_google_adword'] = $this->language->get('help_google_adword');
		$data['help_google_webmaster'] = $this->language->get('help_google_webmaster');
		...
		if (isset($this->request->post['config_google_adword'])) {
			$data['config_google_adword'] = $this->request->post['config_google_adword'];
		} else {
			$data['config_google_adword'] = $this->config->get('config_google_adword');
		}

		if (isset($this->request->post['config_google_adword_status'])) {
			$data['config_google_adword_status'] = $this->request->post['config_google_adword_status'];
		} else {
			$data['config_google_adword_status'] = $this->config->get('config_google_adword_status');
		}

		if (isset($this->request->post['config_google_webmaster'])) {
			$data['config_google_webmaster'] = $this->request->post['config_google_webmaster'];
		} else {
			$data['config_google_webmaster'] = $this->config->get('config_google_webmaster');
		}

		if (isset($this->request->post['config_google_webmaster_status'])) {
			$data['config_google_webmaster_status'] = $this->request->post['config_google_webmaster_status'];
		} else {
			$data['config_google_webmaster_status'] = $this->config->get('config_google_webmaster_status');
		}
