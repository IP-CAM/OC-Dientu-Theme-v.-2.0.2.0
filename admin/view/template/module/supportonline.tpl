...
<div id="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <table id="images" class="list">
          ...
          <tbody id="image-row<?php echo $image_row; ?>">
            <tr>	 
                <td class="left"><input type="text" name="image_avatar[<?php echo $image_row; ?>][position]" value="<?php echo  isset($image['position']) ? $image['position'] : ''; ?>" /></td>
                ...
                <td class="left"><input type="text" name="image_avatar[<?php echo $image_row; ?>][yahoo]" value="<?php echo  isset($image['yahoo']) ? $image['yahoo'] : ''; ?>" /></td>
        ...
        <!-- end image --> 
			<center>If you have any questions please contact: 
             Email: itplusvn@gmail.com - skype: itplusvn - Website <a href="http://itplusvn.com">http://itplusvn.com</a></center> 
  ...
  <script type="text/javascript"><!--
    ...
    function addImage() {
      ...
      html += '<tr>';
      html += '<td class="left"><input type="text" name="image_avatar[' + image_row + '][position]" value="" /></td>';
      ...
      html += '<td class="left"><input type="text" name="image_avatar[' + image_row + '][yahoo]" value="" /></td>';
