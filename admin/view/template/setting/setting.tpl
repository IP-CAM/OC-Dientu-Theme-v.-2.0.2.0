        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-google">
              ...
              <fieldset>
                <legend><?php echo $text_google_adword; ?></legend>
                <div class="alert alert-info"><?php echo $help_google_adword; ?></div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-google-adword"><?php echo $entry_google_adword; ?></label>
                  <div class="col-sm-10">
                    <textarea name="config_google_adword" rows="5" placeholder="<?php echo $entry_google_adword; ?>" id="input-google-analytics" class="form-control"><?php echo $config_google_adword; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-google-adword-status"><?php echo $entry_status; ?></label>
                  <div class="col-sm-10">
                    <select name="config_google_adword_status" id="input-google-adword-status" class="form-control">
                      <?php if ($config_google_adword) { ?>
                      <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                      <option value="0"><?php echo $text_disabled; ?></option>
                      <?php } else { ?>
                      <option value="1"><?php echo $text_enabled; ?></option>
              ...
              <fieldset>
                <legend><?php echo $text_google_webmaster; ?></legend>
                <div class="alert alert-info"><?php echo $help_google_webmaster; ?></div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-google-webmaster"><?php echo $entry_google_webmaster; ?></label>
                  <div class="col-sm-10">
                    <textarea name="config_google_webmaster" rows="5" placeholder="<?php echo $entry_google_webmaster; ?>" id="input-google-webmaster" class="form-control"><?php echo $config_google_adword; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-google-webmaster-status"><?php echo $entry_status; ?></label>
                  <div class="col-sm-10">
                    <select name="config_google_webmaster_status" id="input-google-webmaster-status" class="form-control">
                      <?php if ($config_google_webmaster) { ?>
                      <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                      <option value="0"><?php echo $text_disabled; ?></option>
                      <?php } else { ?>
                      <option value="1"><?php echo $text_enabled; ?></option>
