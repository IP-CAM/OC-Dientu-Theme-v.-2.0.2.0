...
//                if ($price_sale != 0) {
//                    if (($this->config->get('config_customer_price') && $this->customer->isLogged()) || !$this->config->get('config_customer_price')) {
//                        $total = $this->currency->format($this->tax->calculate($product['price_sale'], $product['tax_class_id'], $this->config->get('config_tax')) * $product['quantity']);
//                    } else {
//                        $total = false;
//                    }
//                } else {
	...
	public function add() {
		...
		if ($product_info) {
			...
			if (!$json) {
                ...
                $json['successcart'] = $this->url->link('checkout/cart');
