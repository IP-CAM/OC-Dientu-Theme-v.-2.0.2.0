...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$mail->setSubject(sprintf($this->language->get('email_subject'), $this->request->post['subjectemail']));
		...
		$data['entry_subjectemail'] = $this->language->get('entry_subjectemail');
	    ...
	    if (isset($this->error['subjectemail'])) {
        $data['error_subjectemail'] = $this->error['subjectemail'];
	    } else {
	        $data['error_subjectemail'] = '';
	    }
		...
		if (isset($this->request->post['subjectemail'])) {
			$data['subjectemail'] = $this->request->post['subjectemail'];
		} else {
			$data['subjectemail'] = '';
		}
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['subjectemail']) < 3)) {
			$this->error['subjectemail'] = $this->language->get('error_subjectemail');
		}
