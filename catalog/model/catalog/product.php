...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'price_sale'       => ($query->row['discount'] ? $query->row['discount'] : $query->row['price_sale']),
				'color'            => $query->row['color'],
				'guarantee'        => $query->row['guarantee'],
    ...
    public function getProductss($data = array()) {
        ...
        foreach ($data as $data1) {
            ...
            $sql = "SELECT * FROM " . DB_PREFIX . "product_description pd LEFT JOIN " . DB_PREFIX . "product_to_category ptc ON (pd.product_id = ptc.product_id) LEFT JOIN " . DB_PREFIX . "category_description cd ON (ptc.category_id = cd.category_id) WHERE cd.category_id = '" .$data1['filter_category_id']. "'";
