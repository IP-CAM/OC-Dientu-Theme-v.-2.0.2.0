            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
<?php foreach (unserialize(positions) as $key => $position){ ?><option value="<?php echo $key; ?>" <?php echo $layout_module['position'] == $key ? 'selected="selected"' : false;  ?> ><?php echo $position['label']; ?></option><?php } ?>
...
<?php foreach (unserialize(positions) as $key => $postition){ ?>html += '    <option value="<?php echo $key; ?>"><?php echo $postition['label']; ?></option>';<?php } ?>
