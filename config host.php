...
// HTTP
define('HTTP_SERVER', 'http://dientu.tgmss.com/');

// HTTPS
define('HTTPS_SERVER', 'http://dientu.tgmss.com/');
define('HTTPS_IMAGE', 'http://dientu.tgmss.com/image');

// DIR
define('DIR_APPLICATION', '/home/dientu/public_html/catalog/');
define('DIR_SYSTEM', '/home/dientu/public_html/system/');
define('DIR_LANGUAGE', '/home/dientu/public_html/catalog/language/');
define('DIR_TEMPLATE', '/home/dientu/public_html/catalog/view/theme/');
